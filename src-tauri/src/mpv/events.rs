...
use super::types::{MPV_EVENT_PROPERTY_CHANGE, MPV_EVENT_FILE_LOADED, MPV_EVENT_END_FILE, MPV_EVENT_SHUTDOWN, MpvEvent, MpvEventProperty, MPV_FORMAT_DOUBLE, MPV_FORMAT_FLAG};
    ...
    loop {
        ...
        match evt.event_id {
            ...
            MPV_EVENT_FILE_LOADED => {
                ...
                let _ = app.emit("mpv:file-loaded", PlaybackService::current_title(mpv));
            }
