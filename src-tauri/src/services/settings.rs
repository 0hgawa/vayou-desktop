...
impl Default for SubtitleStyleSettings {
    fn default() -> Self {
        Self {
            font: "Segoe UI".into(),
            // mpv's own default — the only documented recommendation for this
            // number. The 55 this carried was 45% above it with nothing behind it.
            size: 38,
            color: "#ffffff".into(),
...
mod tests {
    ...
    fn touch_recent_preserves_track_selections() {
        ...
        // Re-touching the same file must not drop the saved tracks.
