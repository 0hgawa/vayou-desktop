...
export default {
  ...
  delay: "Задержка",
  translate: "Перевести",
  extractingSubs: "Извлечение субтитров",
  translatingSubs: "Перевод",
  style: "Стиль",
  back: "Назад",
  reset: "Сброс",
  font: "Шрифт",
  ...
  subErrImageBased: "Эти субтитры основаны на изображении и не могут быть переведены.",
  subErrRateLimited: "Не удалось перевести — сервис занят. Повторите попытку через мгновение.",
  subErrNoTrack: "Дорожка субтитров не выбрана.",
  subErrNoEntries: "Не найден текст субтитров для перевода.",
  subErrNoFile: "Нет воспроизводимого файла.",
} satisfies Dict;
